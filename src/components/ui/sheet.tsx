 ...
 * stranded at the bottom of a tall desktop viewport. Used for quick actions layered on top
 * of a page (e.g. the tier/compare review flow) rather than whole pages in their own right.
 */
